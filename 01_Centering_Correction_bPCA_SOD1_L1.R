...
load("lib1_bPCA_results_fitness_replicates.RData")
...
save(all_variants_stop, file="all_variants_SOD1_stops_newfilter.RData")
save(silent, all_variants, all_variants_stop, file="Fscore_df_SOD1_all_variants_identity.RData")



#Save Lib1 scores table####
bpca_l1 <- select(all_variants_stop, aa_seq, ID, type, count_e1_s0, count_e2_s0, count_e3_s0, count_e1_s1, count_e2_s1, count_e3_s1, input_mean_count, output_mean_count, bscore1_c, bscore2_c, bscore3_c, bscore_c, sigma, sigma_norm_iqr, low_sigma)
bpca_l1$library <- 1
...
write.csv(bpca_l1, file = "bPCA_L1_table.csv", row.names = FALSE)
