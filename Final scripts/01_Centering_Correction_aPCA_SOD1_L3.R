...
load("SOD3_final_fitness_replicates.RData")
...
save(all_variants_stop, file="all_variants_SOD1_stops_newfilter_L3_aPCA.RData")
save(silent, all_variants, all_variants_stop, file="Fscore_df_SOD1_all_variants_identity_L3_aPCA.RData")



#Save Lib3 scores table####
apca_l3 <- select(all_variants_stop, aa_seq, ID, type, count_e1_s0, count_e2_s0, count_e3_s0, count_e1_s1, count_e2_s1, count_e3_s1, input_mean_count, output_mean_count, ascore1_c, ascore2_c, ascore3_c, ascore_c, sigma, sigma_norm_iqr, low_sigma)
apca_l3$library <- 3
...
write.csv(apca_l3, file = "aPCA_L3_table.csv", row.names = FALSE)
